...
void CodeUpdate::setVersions()
{
    ...
    fwUpdateMatcher
        .push_back(
            std::make_unique<sdbusplus::bus::match::match>(pldm::utils::
                                                               DBusHandler::
                                                                   getBus(),
                                                           ...
                                                           [this](
                                                                   ...
                                                                   interfaces)
                                                               {
                                                                       ...
                                                                       "xyz.openbmc_project.Software.Activation")
                                                                   {
                                                                       ...
                                                                       {
                                                                           error(
                                                                               "Code Update: Error getting Activation property, PATH={IMG_OBJ}, INTERFACE={INTF}, PROPERTY=ACTIVATION, ERROR={ERR_EXCEP}",
                                                                               "IMG_OBJ",
                                                                               imageObjPath,
                                                                               "INTF",
                                                                               imageInterface,
