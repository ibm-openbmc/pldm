...
#include <string.h>
    ...
    enum changePasswordReasonCode
    {
        ...
        BadPasswordForUnknownReason, // The reason why the new password was not
                                     // accepted is unknown
        ...
        BadPasswordNotEnoughCharacterClasses, // The new password does not have
                                              // enough different kinds of
                                              // characters: lowercase, uppcase,
                                              // numbers, and other
        BadPasswordTooLongMonotonicSequence, // the new password has a monotinic
                                             // sequence, like 1234
        BadPasswordNoPasswordSupplied,       // The new password is empty (zero
                                             // length)
        BadPasswordDictionaryCheck, // The new password contains a dictionary
                                    // word
        // Codes from pam_ipmicheck.so:  etc.
        PasswordTooLongforIPMIUser =
            2000, // IPMI users are limited to 20 character passwords
    };
