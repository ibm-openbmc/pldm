...
int main(int argc, char *argv[])
{
  if (argc == 3)
  {
    ...
    authenticate(argv[1], argv[2], &authenticated, &passwordChangeRequired, &operationAllowed);
    printf("authenticated=%d, passwordChangeRequired=%d, operationAllowed=%d\n", (int)authenticated, (int)passwordChangeRequired, (int)operationAllowed);
